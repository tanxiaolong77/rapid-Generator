...
public class TuserRecommend extends BaseEntity implements java.io.Serializable{
	...
	public static final String ALIAS_RECOMMEND_COUNT = "最大推荐数量";
	...
	@Column(name = "recommend_count", unique = false, nullable = false, insertable = true, updatable = true, length = 10)
