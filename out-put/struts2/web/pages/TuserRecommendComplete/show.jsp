...
<rapid:override name="content">
	<s:form action="/pages/TuserRecommendComplete/list.do" method="get" theme="simple">
		<input type="button" value="返回列表" onclick="window.location='${ctx}/pages/TuserRecommendComplete/list.do'"/>
		...
		<table class="formTable">
			...
			<tr>	
				...
				<td><s:property value="%{model.recommendRuleId}" /></td>
			</tr>
			<tr>	
