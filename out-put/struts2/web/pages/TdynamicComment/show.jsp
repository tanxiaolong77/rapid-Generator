...
<rapid:override name="content">
	<s:form action="/pages/TdynamicComment/list.do" method="get" theme="simple">
		<input type="button" value="返回列表" onclick="window.location='${ctx}/pages/TdynamicComment/list.do'"/>
		...
		<table class="formTable">
			<tr>	
				...
				<td><s:property value="%{model.dynamicId}" /></td>
			</tr>
			<tr>	
			...
			<tr>	
				...
				<td><s:property value="%{model.comment}" /></td>
			</tr>
			<tr>	
